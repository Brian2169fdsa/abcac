...
export function BlogLibrary({ posts, categories }: BlogLibraryProps) {
  ...
  return (
    <div>
      <div className="flex flex-col gap-5 rounded-[1.5rem] border border-ink/10 bg-white/75 p-4 shadow-[0_20px_60px_-48px_rgba(13,34,63,0.65)] backdrop-blur sm:p-5">
        ...
        <div className="flex gap-2 overflow-x-auto pb-1" aria-label="Filter articles by category">
            ...
            <button
              ...
              className={cn(
                ...
                activeCategory === category
                  ...
                  : "border-ink/10 bg-surface text-muted hover:border-brand/25 hover:text-brand",
              )}
            >
              {category}
            </button>
