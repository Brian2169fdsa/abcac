...
export const MOCK_TASKS: MockTask[] = [
  ...
  },
  {
    id: "t-504",
    kind: "application",
    title: "Document request overdue — Noah Brooks (CADC)",
    detail: "Official transcript requested 10 days ago for the application file — still outstanding.",
    member: "Noah Brooks",
    priority: "low",
    due: "Due in 9 days",
...
export const MEMBER_TASKS_DEMO: MemberTaskDemo[] = [
  ...
  {
    id: "mt-3",
    title: "Ethics CEU hours still needed",
    detail: "ABCAC requires ethics CEUs each renewal cycle. You have 3 of 6 ethics hours logged — one ethics course closes the gap.",
    due: "Before renewal",
    priority: "medium",
    cta: "Find ethics CEUs",
    href: "/account/ceus",
  },
  {
    id: "mt-4",
