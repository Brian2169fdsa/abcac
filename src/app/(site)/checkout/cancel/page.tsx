  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-5 py-14 text-center md:px-8 md:py-20">
      ...
      <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-wrap sm:items-center">
        <CtaButton href="/store" className="w-full sm:w-auto">Return to store</CtaButton>
        <CtaButton href="/contact" variant="outline" className="w-full sm:w-auto">Contact ABCAC</CtaButton>
      </div>
    </div>
  );
}
